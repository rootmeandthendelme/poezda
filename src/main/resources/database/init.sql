...
--
-- Name: passenger; Type: TABLE; Schema: public; Owner: intuser
--
...
ALTER TABLE public.passenger OWNER TO intuser;
...
--
-- Data for Name: passenger; Type: TABLE DATA; Schema: public; Owner: intuser
--

COPY public.passenger (id, full_name, passport) FROM stdin;
\.
...
COPY public.reservation (id, seat_id, passenger_id, startpoint_id, endpoint_id) FROM stdin;
\.
...
--
-- Name: passenger passenger_pkey; Type: CONSTRAINT; Schema: public; Owner: intuser
--
...
--
-- Name: reservation passenger_id; Type: FK CONSTRAINT; Schema: public; Owner: intuser
--

ALTER TABLE ONLY public.reservation
    ADD CONSTRAINT passenger_id FOREIGN KEY (passenger_id) REFERENCES public.passenger(id);
